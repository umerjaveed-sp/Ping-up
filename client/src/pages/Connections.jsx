        ...
        <div className="inline-flex flex-wrap items-center border border-gray-200 rounded-md p-1 bg-white shadow-sm ">
          {dataArrray.map((tab) => (
            <button
              ...
              key={tab.label}
              className={`flex items-center px-3 py-1 text-sm rounded-md cursor-pointer  transition-colors ${currentTab === tab.label ? "bg-white font-medium text-black" : "text-gray-500 hover:text-black"}`}
            >
              ...
              >
                ...
                <div className="flex-1 ">
                  ...
                  <div className="flex max-sm:flex-col gap-2 mb\t-4">
                    {
                      <button
                        onClick={() => nevigate(`/profile/${user._id}`)}
                    ...
                    {currentTab === "Connections" && (
                      <button
                        onClick={() => nevigate(`/messages/${user._id}`)}
