  ...
  return (
    ...
    >
      <div className="w-full  ">
        ...
        <Link
          to="/create-post"
          className="flex items-center justify-center gap-2 py-2.5 mt-6 rounded-lg bg-linear-to-r from-indigo-500 to-purple-600 hover:from-indigo-700 havor:to-purple-800 active:scale-95 transition text-white cursor-pointer "
        >
